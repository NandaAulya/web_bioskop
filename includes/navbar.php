                ...
                <div class="relative ml-3" x-data="{ open: false }">
                    <div>
                        <button type="button" @click="open = !open"
                            class="relative flex bg-gray-800 text-sm"
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <a href="#" class="block px-4 py-2 text-sm text-white-200 hover:bg-gray-100 font-poppins"
                            role="menuitem" tabindex="-1" id="profile">Your Profile</a>
                        <a href="#" class="block px-4 py-2 text-sm text-white-200 hover:bg-gray-100 font-poppins"
                            role="menuitem" tabindex="-1" id="setting">Settings</a>
...
<script>
    function setActive(path) {
        ...
        return isActive ? 'bg-gray-700 text-[#ebebf8] hover:bg-[#c65482] hover:text-white rounded-md px-3 py-2 text-base font-poppins font-semibold' : 'text-gray-100 hover:text-white rounded-md px-3 py-2 text-base font-poppins font-semibold';
    }
